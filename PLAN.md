...
**Ladder status at a glance:** V0–V6 green (V4 row 7, V6.4, V6.5 parked — §3); V7, V8 never run (queued S11, S12). W0–W3 green; W4–W8 never run (S6–S12).
...
- [ ] W4–W5 pass on one connection, with A15 — **S6–S7**

...
- **Dongle** (`dongle/`) — nRF52840 USB bridge that receives BLE events from the remotes and forwards them to the scoreboard web app over a USB CDC-ACM serial link. See [`PROTOCOL.md`](PROTOCOL.md) for the wire protocol.
